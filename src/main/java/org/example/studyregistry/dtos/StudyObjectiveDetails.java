package org.example.studyregistry.dtos;

import java.util.Objects;

public class StudyObjectiveDetails {
    ...
    private StudyObjectiveDetails(Builder builder) {
        this.id = builder.id;
    ...
    // Builder class to construct StudyObjectiveDetails
    public static class Builder {
        ...
        public StudyObjectiveDetails build() {
            return new StudyObjectiveDetails(this);
        }
    }
}
