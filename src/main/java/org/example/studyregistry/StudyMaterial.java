...
public class StudyMaterial {
    ...
    private void updateReferenceCount(Map<String, Integer> response, Reference reference) {
    ...
    private void handleVideoReference(Map<String, Integer> response, VideoReference reference) {
        if (reference.handleStreamAvailability()) {
            incrementCount(response, "Video References");
        }
    }

    private void handleTextReference(Map<String, Integer> response, TextReference reference) {
